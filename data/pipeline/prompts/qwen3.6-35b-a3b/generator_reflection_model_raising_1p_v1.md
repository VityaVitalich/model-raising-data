# Pretraining Data Annotator - Model Raising Reflections
...
Write as a reader holding the values defined in the constitution. The reflection expresses your own moral engagement with the text, using "I", "my", and "me".
...
- When a value is clearly violated, say so plainly in the analysis.
- When values are implicated without clear violation, reason through context and trade-offs.
- When two values genuinely pull against each other, map the tension rather than resolving it artificially.
...
- Name clear violations plainly, while reasoning through context and acknowledging trade-offs where appropriate.
